...
[![Auth](https://img.shields.io/badge/Auth-bryant--rh-ff69b4)](https://github.com/bryant-rh)
[![GitHub contributors](https://img.shields.io/github/contributors/bryant-rh/cloud_dns_exporter)](https://github.com/bryant-rh/cloud_dns_exporter/graphs/contributors)
[![GitHub Pull Requests](https://img.shields.io/github/issues-pr/bryant-rh/cloud_dns_exporter)](https://github.com/bryant-rh/cloud_dns_exporter/pulls)
[![GitHub Pull Requests](https://img.shields.io/github/stars/bryant-rh/cloud_dns_exporter)](https://github.com/bryant-rh/cloud_dns_exporter/stargazers)
[![HitCount](https://views.whatilearened.today/views/github/bryant-rh/cloud_dns_exporter.svg)](https://github.com/bryant-rh/cloud_dns_exporter)
[![GitHub license](https://img.shields.io/github/license/bryant-rh/cloud_dns_exporter)](https://github.com/bryant-rh/cloud_dns_exporter/blob/main/LICENSE)
[![](https://img.shields.io/badge/Awesome-MyStarList-c780fa?logo=Awesome-Lists)](https://github.com/bryant-rh/awesome-stars-bryant-rh#readme)
...
可以直接在 [Release](https://github.com/bryant-rh/cloud_dns_exporter/releases) 发布页面下载二进制，然后更改配置文件，直接运行即可。
...
镜像地址：
- 国外: `bryant-rh/cloud_dns_exporter`
- 国内: `registry.cn-hangzhou.aliyuncs.com/bryant-rh/cloud_dns_exporter`

目前应用还提供了`-v`参数，用于打印当前所使用的版本信息。

### 阿里云内网域名监控配置

对于阿里云用户，项目支持同时监控公网域名和内网域名（PrivateZone）。内网域名监控默认关闭，可通过配置开启：
  ...
  aliyun:
    accounts:
      - name: 阿里云账号1
        ...
        # 可选：STS角色ARN，用于跨账号访问
        roleArn: "acs:ram::123456789012:role/AliyunDNSExporterRole"
        # 可选：内网域名监控开关，默认false
        enablePrivateDNS: true  # 设置为true启用内网域名监控
```

**注意事项：**
- `enablePrivateDNS` 默认为 `false`，只监控公网域名
- 设置为 `true` 时，会同时采集公网域名和内网域名（PrivateZone）
- 内网域名监控需要相应的权限，确保账号有访问PrivateZone的权限
