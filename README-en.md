...
![cloud_dns_exporter](https://socialify.git.ci/bryant-rh/cloud_dns_exporter/image?description=1&descriptionEditable=Gradually%20move%20towards%20the%20four%20modernizations%20of%20operation%20and%20maintenance:%20normalization,%20standardization,%20efficiency,%20and%20elegance&font=Bitter&forks=1&issues=1&language=1&name=1&owner=1&pattern=Circuit%20Board&pulls=1&stargazers=1&theme=Light)
...
You can download the binary directly from the [Release](https://github.com/bryant-rh/cloud_dns_exporter/releases) release page, then change the configuration file and run it directly.
...
Image Address ：
- Abroad: `bryant-rh/cloud_dns_exporter`
- Domestic: `registry.cn-hangzhou.aliyuncs.com/bryant-rh/cloud_dns_exporter`
