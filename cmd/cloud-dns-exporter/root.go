...
import (
	...
	"github.com/bryant-rh/cloud_dns_exporter/pkg/export"
...
func RunServer() {
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		_, err := w.Write([]byte(`<html>
			...
			<p><a href='https://github.com/bryant-rh/cloud_dns_exporter'>Source Repo</a></p>
			<p><a href='https://github.com/bryant-rh'>Create By Bryant-rh</a></p>
			</body>
			</html>`))
		if err != nil {
